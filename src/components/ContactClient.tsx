        ...
        return (
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <button className="btn-primary" style={{ width: '100%' }} onClick={() => { if (validate(['name', 'email', 'company'])) handleSubmit(); }} disabled={submitting}>
                {submitting ? 'Submitting...' : 'Submit'}
              </button>
            </div>
          </div>
        ...
        return (
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <button className="btn-primary" style={{ width: '100%' }} onClick={() => { if (validate(['name', 'email', 'message'])) handleSubmit(); }} disabled={submitting}>
          ...
          <div>
            ...
            <AnimateOnScroll>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 32 }}>
                ...
                <a href="mailto:info@zirka.solutions" style={{ display: 'flex', gap: 12, alignItems: 'center', color: 'var(--text-body)', fontSize: 15 }}>
                  <Mail size={18} color="var(--accent)" /> info@zirka.solutions
                </a>
              </div>
            </AnimateOnScroll>
