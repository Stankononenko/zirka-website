...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Zirka Solutions. Learn how we collect, use, and protect your personal information in accordance with Canadian privacy laws (PIPEDA).',
};
